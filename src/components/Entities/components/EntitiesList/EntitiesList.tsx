...
import { MenuIcon, GridIcon, ListIcon, FilterIcon, MaximizeIcon, ShareIcon, MinimizeIcon, CrosshairIcon } from 'styles/icons';

import { EntityType } from 'components/api/types';
      ...
      <EntitiesFilters>
        <div>
          ...
          <FilterButton onClick={toggleFullscreenActive}>
            {isFullscreenActive ? <MinimizeIcon/> : <MaximizeIcon />}
          </FilterButton>
          <FiltersSeparator />
