...
import { Tag, Entity, Fee } from 'components/api/types';
...
const UserContextProvider: React.FC<Props> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    setProfileTags([
      {name: 'Merges and acquisition', id: 0, category: 'expertise'},
      {name: 'Cross borders operation', id: 1, category: 'expertise'},
      {name: 'Phasellus efficitur', id: 2, category: 'specialities'},
      {name: 'Vestibulum convallis', id: 3, category: 'specialities'},
      {name: 'Duis vitae', id: 4, category: 'admissions'},
      {name: 'Aliquam ac', id: 5, category: 'admissions'},
      {name: 'Vestibulum convallis efficitur', id: 6, category: 'countries'},
      {name: 'tristique mauris', id: 7, category: 'countries'}
    ]);
